...
// 마지막으로 연 나라명 저장용 (script.js가 초기 언어를 세팅/브로드캐스트함)
...
const countryData = {
  "Philippines": {
    title: { ko: "필리핀: 정용석, 구효실 선교사님", en: "Philippines — Missionaries Jung Yongseok & Koo Hyosil" },
    desc: {
  ...
  "Thailand": {
    title: { ko: "태국: 신동운·박향실 / 허수성·허인영 선교사님", en: "Thailand — Missionaries Shin Dongwoon & Park Hyangsil / Heo Soosung & Heo Inyoung" },
    desc: {
  ...
  "South Africa": {
    title: { ko: "남아공화국: 이기쁨 선교사님", en: "South Africa — Missionary Lee Gippeum" },
    desc: {
  ...
  "United Kingdom": {
    title: { ko: "웨일즈(영국): 이성수, 백나나 선교사님", en: "Wales (UK) — Missionaries Lee Sungsoo & Baek Nana" },
    desc: {
  ...
  "Turkey": {
    title: { ko: "터키: 강현아 선교사님", en: "Turkey — Missionary Kang Hyunah" },
    desc: {
  ...
  "Russia": {
    title: { ko: "러시아: 장석천, 장경희 선교사님", en: "Russia — Missionaries Jang Seokcheon & Jang Kyunghee" },
    desc: {
  ...
  "Cameroon": {
    title: { ko: "카메룬: 송은천, 최현수 선교사님", en: "Cameroon — Missionaries Song Eunchun & Choi Hyunsu" },
    desc: {
  ...
  "Malaysia": {
    title: { ko: "말레이시아: 이종대, 안미숙 선교사님", en: "Malaysia — Missionaries Lee Jongdae & Ahn Misook" },
    desc: {
  ...
  "Japan": {
    title: { ko: "일본: 소기호, 정민임 선교사님", en: "Japan — Missionaries So Giho & Jung Min-im" },
    desc: {
  ...
  "Indonesia": {
    title: { ko: "인도네시아: 김학봉, 서미식 선교사님", en: "Indonesia — Missionaries Kim Hakbong & Seo Misik" },
    desc: {
  ...
  "United States of America": {
    title: { ko: "미국", en: "United States of America" },
    desc: {
  ...
  "South Korea": {
    title: { ko: "한국: 김태주, 고은숙 목사님", en: "South Korea — Pastors Kim Taejoo & Ko Eunsuk" },
    desc: {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function showCountryInfo(countryName) {
    ...
    // language (script.js가 window.currentLanguage를 유지)
